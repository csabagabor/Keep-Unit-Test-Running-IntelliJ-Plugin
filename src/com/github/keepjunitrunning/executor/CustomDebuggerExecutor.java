...
public class CustomDebuggerExecutor extends DefaultDebugExecutor {
    @NonNls
    public static final String WITH_PARALLEL_RUNNER = "Debug with Keep Unit Test Debugger";

    public static final String DEBUG_WITH_PARALLEL_RUNNER = "DebugKeepJUnitRunning";
